        ...
        <div className="panel-body">
          <div className="row">
            <div className="col-md-4">
              <img src={this.props.userData.avatar_url} className="thumbnail" alt="user" style={{width:"100%"}}/>
            </div>
            <div className="col-md-8">
              ...
              <br />
              <a className="btn btn-primary" target="_blank" href={this.props.userData.html_url}>Go to profile</a>
            </div>
          </div>
          <hr />
          <h3>Users repos</h3>
